...
const IHK_ERLAUBNISSE_URL =
  "https://www.ihk.de/themen/gruendung/erlaubnispflichtige-gewerbe";

// hwk.de — Handwerkskammer; primary authority for Meisterpflicht trades.
const HWK_MEISTER_URL =
  "https://www.hwk.de/themen/meisterpflicht-anlage-a";
...
interface ParsedPermit {
  ...
  costsEur: string | null;
  processingTimeDays: string | null;
...
// Official 2025 data from GewO, HwO, DGUV.
...
type BaselinePermit = Omit<ParsedPermit, "contentHash">;
type BaselineBG = Omit<ParsedBG, "contentHash">;

const BASELINE_PERMITS: BaselinePermit[] = [
  // ── Erlaubnispflichtige Gewerbe (§§ 30–38, 55 GewO) ─────────────────────

  {
    ...
    legalBasis:
      "GastG Bayern Art. 2, GastG Niedersachsen, GastG Sachsen-Anhalt, GastG Thüringen; § 14 GewO (Gewerbeanmeldung); VO (EG) 852/2004 (Lebensmittelhygiene)",
...

  {
    ...
    descriptionDe:
      "Der Betrieb eines Taxiunternehmens oder Mietwagenunternehmens bedarf einer Genehmigung nach dem Personenbeförderungsgesetz (PBefG). Die Genehmigung wird für jedes einzelne Fahrzeug erteilt und ist an die Person des Unternehmers gebunden. Voraussetzungen: Zuverlässigkeit, finanzielle Leistungsfähigkeit, fachliche Eignung (Unternehmerprüfung oder Ausnahmeregelung). Taxi: Betriebspflicht und Beförderungspflicht (§ 22 PBefG). Mietwagen: Rückkehrpflicht zum Betriebssitz (§ 49 Abs. 4 PBefG). Für Ridesharing-Dienste (§ 50 PBefG) und gebündelte Bedarfsverkehre (§ 44 PBefG) gelten seit der PBefG-Novelle 2021 gesonderte Regelungen.",
    authorityType: "Genehmigungsbehörde (Landratsamt, kreisfreie Stadt)",
    authorityLevel: "local",
    requiredDocuments:
      "Gewerbeanmeldung, Führungszeugnis (Belegart O), Auszug aus dem Gewerbezentralregister, Nachweis der finanziellen Leistungsfähigkeit, Nachweis der fachlichen Eignung (IHK-Fachkundeprüfung), Fahrzeugpapiere (Zulassung, HU, Taxameter-Eichbescheinigung), Nachweis der Kfz-Haftpflichtversicherung",
    costsEur: "200–800 € pro Fahrzeug",
    processingTimeDays: "30–90 Tage",
    legalBasis:
      "§§ 2, 13, 21, 22, 47–49 PBefG (Personenbeförderungsgesetz); BOKraft (Betriebsordnung für den Straßenpersonenverkehr)",
    sourceUrl: IHK_ERLAUBNISSE_URL,
  },

  {
    ...
    authorityLevel: "local",
    requiredDocuments:
      "Führungszeugnis (Belegart O), Auszug aus dem Gewerbezentralregister, Nachweis der Zuverlässigkeit, Nachweis geordneter Vermögensverhältnisse (Schufa, kein Insolvenzverfahren), Nachweis der Haftpflichtversicherung (mind. 1 Mio. € Personenschäden, 750.000 € Sachschäden), IHK-Unterrichtungsnachweis (40 h) oder Sachkundeprüfung",
    costsEur: "200–1.000 €",
...

  {
    ...
    authorityLevel: "local",
    requiredDocuments:
      "Führungszeugnis (Belegart O), Auszug aus dem Gewerbezentralregister, Lichtbild, Nachweis der Zuverlässigkeit",
    costsEur: "30–100 €",
...

  {
    ...
    authorityLevel: "local",
    requiredDocuments:
      "Führungszeugnis (Belegart O), Auszug aus dem Gewerbezentralregister, Nachweis geordneter Vermögensverhältnisse, Nachweis geeigneter Betriebsräume",
    costsEur: "150–500 €",
    processingTimeDays: "30–60 Tage",
...

  {
    ...
    descriptionDe:
      "Der Betrieb eines Maurer- und Betonbauerhandwerks in zulassungspflichtigem Handwerk (Anlage A HwO) erfordert die Eintragung in die Handwerksrolle. Voraussetzung ist ein Meisterbrief im Maurer- und Betonbauerhandwerk oder ein gleichwertiger Abschluss. Alternativ: Zulassung mit Ausnahmegenehmigung (§ 8 HwO) bei nachgewiesenen besonderen Kenntnissen oder EU-Anerkennungsrichtlinie (EU-Berufsanerkennungsrichtlinie 2005/36/EG für Inhaber ausländischer Berufsqualifikationen). Der Betrieb ohne Eintragung ist eine Ordnungswidrigkeit (§ 117 HwO). Ausnahmen: Nebenbetriebe gewerblicher Unternehmen (§ 3 HwO), Hilfsbetriebe (§ 5 HwO).",
    authorityType: "Handwerkskammer (HWK)",
    authorityLevel: "state",
    requiredDocuments:
      "Meisterbrief (Maurer und Betonbauer) oder gleichwertige Qualifikation, Personalausweis, Gewerbeanmeldung",
...

  {
    ...
    authorityLevel: "state",
    requiredDocuments:
      "Meisterbrief (Elektrotechniker) oder anerkannte Qualifikation, Personalausweis, Gewerbeanmeldung, ggf. Nachweis des Konzessionsvertrags mit dem Netzbetreiber",
    costsEur: "150–400 €",
    processingTimeDays: "14–30 Tage",
...

  {
    ...
    descriptionDe:
      "Das Schornsteinfegerhandwerk ist zulassungspflichtiges Handwerk (Anlage A Nr. 12 HwO). Zusätzlich zur Eintragung in die Handwerksrolle mit Meisterbrief verwaltet das Schornsteinfegerrecht ein duales System: Bevollmächtigte Bezirksschornsteinfeger werden durch die zuständige Behörde für 7 Jahre für einen bestimmten Kehrbezirk bestellt und führen hoheitliche Aufgaben durch (Feuerstättenbeschauen, Feuerstättenbescheid, Überprüfung nach Kehr- und Überprüfungsordnung). Freie Schornsteinfegerbetriebe können ohne Bestellung tätig sein (seit SchfHwG 2013), führen aber keine hoheitlichen Aufgaben durch.",
    authorityType: "Handwerkskammer (HWK); zuständige Behörde (Bestellung)",
    authorityLevel: "state",
    requiredDocuments:
      "Meisterbrief (Schornsteinfeger), Personalausweis, Gewerbeanmeldung, ggf. Bewerbung für Bezirksstelle",
    costsEur: "150–400 €",
    processingTimeDays: "14–30 Tage",
    legalBasis:
      "Anlage A Nr. 12 HwO; §§ 1, 7, 8 HwO; SchfHwG (Schornsteinfeger-Handwerksgesetz)",
    sourceUrl: HWO_URL,
  },

  {
    ...
    authorityLevel: "state",
    requiredDocuments:
      "Meisterbrief (Friseur), Personalausweis, Gewerbeanmeldung",
    costsEur: "150–400 €",
    processingTimeDays: "14–30 Tage",
...

  {
    ...
    authorityLevel: "state",
    requiredDocuments:
      "Meisterbrief (Augenoptiker), Personalausweis, Gewerbeanmeldung",
    costsEur: "150–400 €",
    processingTimeDays: "14–30 Tage",
...

  {
    ...
    descriptionDe:
      "Das Zahntechnikerhandwerk (Herstellung von Zahnersatz, Zahnprothesen, kieferorthopädischen Apparaten) ist zulassungspflichtiges Handwerk (Anlage A Nr. 37 HwO). Zahntechniker arbeiten ausschließlich auf Auftrag von Zahnärzten und haben keinen direkten Patientenkontakt. Die Eintragung in die Handwerksrolle mit Meisterbrief ist für den Betriebsinhaber verpflichtend. Medizinprodukte (Zahnersatz) unterliegen der Medizinprodukteverordnung (EU) 2017/745 (MDR) — eine CE-Zertifizierung als Hersteller ist erforderlich.",
    authorityType: "Handwerkskammer (HWK)",
    authorityLevel: "state",
    requiredDocuments:
      "Meisterbrief (Zahntechniker), Personalausweis, Gewerbeanmeldung, Registrierung als Medizinproduktehersteller (EUDAMED)",
    costsEur: "150–400 €",
    processingTimeDays: "14–30 Tage",
    legalBasis:
      "Anlage A Nr. 37 HwO; §§ 1, 7, 8 HwO; EU MDR 2017/745 (Medizinprodukteverordnung)",
    sourceUrl: HWO_URL,
  },

  {
    ...
    descriptionDe:
      "Das Kraftfahrzeugtechnikerhandwerk (Diagnose, Reparatur und Wartung von Kraftfahrzeugen und deren Subsystemen) ist zulassungspflichtiges Handwerk (Anlage A Nr. 13 HwO). Die Eintragung in die Handwerksrolle mit Meisterbrief (Kraftfahrzeugtechniker) ist für den Betriebsinhaber verpflichtend. Zusätzliche Qualifikationen: für HU/AU-Berechtigte (§ 29 StVZO) ist die Anerkennung als Kraftfahrzeugsachverständigen-Beauftragter durch TÜV/DEKRA/GTÜ etc. notwendig. Betriebe mit Klimaanlagenwartung benötigen eine Zertifizierung nach EU 307/2008 (F-Gase-Verordnung).",
    authorityType: "Handwerkskammer (HWK)",
    authorityLevel: "state",
    requiredDocuments:
      "Meisterbrief (Kraftfahrzeugtechniker), Personalausweis, Gewerbeanmeldung, ggf. HU/AU-Berechtigung, ggf. F-Gase-Zertifizierung",
    costsEur: "150–400 €",
    processingTimeDays: "14–30 Tage",
    legalBasis:
      "Anlage A Nr. 13 HwO; §§ 1, 7, 8 HwO; § 29 StVZO (HU/AU); EU-VO 307/2008 (F-Gase)",
    sourceUrl: HWO_URL,
  },
...

  {
    ...
    authorityType:
      "Zugelassene Überwachungsstelle (ZÜS): TÜV, DEKRA, GTÜ, SÜD, Rheinland",
    authorityLevel: "federal",
    requiredDocuments:
      "CE-Konformitätserklärung des Herstellers, Betriebsanleitung, Prüfbuch, Gefährdungsbeurteilung nach BetrSichV, Betreibernachweis",
    costsEur: "Abhängig von Größe und Art der Anlage (500–10.000 € pro Prüfung)",
    processingTimeDays: "Nach Vereinbarung mit ZÜS",
    legalBasis:
      "§§ 37–39 GewO; BetrSichV § 14–16; ProdSG § 2 Nr. 30; DruckgeräteV (14. ProdSV); EU DGRL 2014/68/EU",
    sourceUrl: GEWO_URL,
  },

  {
    ...
    descriptionDe:
      "Aufzugsanlagen (Personen- und Lastenaufzüge, Fahrtreppen, Förderanlagen) sind überwachungsbedürftige Anlagen nach § 37 GewO i. V. m. BetrSichV Anhang 2 Abschnitt 2. Pflichten des Betreibers: Prüfung vor erstmaliger Inbetriebnahme und nach wesentlichen Änderungen durch zugelassene Überwachungsstelle (ZÜS); wiederkehrende Hauptprüfung alle 2 Jahre, Zwischenprüfung alle 2 Jahre (versetzt), durch ZÜS oder befähigte Person. Notrufanlage nach EN 81-28 und Wartungsvertrag mit Aufzugsfirma sind gesetzlich vorgeschrieben. Betreiber haften für Unfälle bei mangelhafter Prüfung.",
    authorityType:
      "Zugelassene Überwachungsstelle (ZÜS): TÜV, DEKRA, GTÜ; zuständige Landesbehörde",
    authorityLevel: "state",
    requiredDocuments:
      "CE-Konformitätserklärung, Betriebsanleitung, Prüfbuch, Wartungsvertrag, Nachweis der Notrufanlage, Gefährdungsbeurteilung",
    costsEur: "500–3.000 € pro Prüfung",
    processingTimeDays: "Nach Vereinbarung mit ZÜS",
    legalBasis:
      "§§ 37–39 GewO; BetrSichV Anhang 2 Abschnitt 2; AufzV (12. ProdSV); EU AufzugsRL 2014/33/EU; EN 81-20, EN 81-50",
    sourceUrl: GEWO_URL,
  },
];

const BASELINE_BGS: BaselineBG[] = [
  {
    bgKey: "bg-bau",
    name: "Berufsgenossenschaft der Bauwirtschaft",
    shortName: "BG BAU",
    sectorDescription:
      "Zuständige Berufsgenossenschaft für alle Unternehmen der Bauwirtschaft, des Gebäudereinigerhandwerks und weiterer bauverwandter Gewerbe. Alle Unternehmer und deren Beschäftigte im Baugewerbe sind kraft Gesetzes Mitglied der BG BAU (§ 2 SGB VII). Freiwillige Versicherung für Unternehmer ohne Beschäftigte möglich.",
    sectors:
      "Hochbau, Tiefbau, Ausbaugewerbe, Zimmerer, Dachdecker, Gerüstbau, Estrichleger, Fliesen-/Plattenleger, Maler und Lackierer, Gebäudereinigung, Schornsteinfeger, Stuckateure",
  ...
  },
  {
    ...
    shortName: "BG RCI",
    sectorDescription:
      "Zuständig für Unternehmen der Rohstoffgewinnung, der Chemischen Industrie, der Kautschukherstellung und des Mineralölhandels. Pflichtmitgliedschaft nach § 2 SGB VII für alle Arbeitgeber und deren Beschäftigte in diesen Branchen.",
    sectors:
      "Chemische Industrie, Kunststoffverarbeitung, Kautschuk, Bergbau, Steinbrüche, Mineralölverarbeitung, Mineralölhandel, Papier und Pappe, Kunststoff",
    membershipMandatory: true,
  ...
  },
  {
    ...
    shortName: "BGHM",
    sectorDescription:
      "Größte gewerbliche Berufsgenossenschaft Deutschlands. Zuständig für Betriebe der metallverarbeitenden Industrie und des Metallhandwerks sowie der holzbe- und -verarbeitenden Industrie und des Tischlerhandwerks.",
    sectors:
      "Metallverarbeitung, Stahlbau, Maschinenbau, Elektroinstallation (Betriebe), Tischler, Schreiner, Holzbe- und -verarbeitung, Möbelherstellung, Sägewerke, Glasverarbeitung, Feinmechanik, Uhrmacher",
    membershipMandatory: true,
  ...
  },
  {
    ...
    shortName: "BGN",
    sectorDescription:
      "Zuständig für alle Unternehmen der Nahrungsmittelherstellung und -verarbeitung sowie des Gastgewerbes (Gastronomie, Hotellerie). Pflichtmitgliedschaft auch für Einzelunternehmer ohne Beschäftigte in diesen Branchen.",
    sectors:
      "Gastronomie, Hotellerie, Catering, Bäcker, Konditoren, Fleischer, Lebensmittelproduktion, Getränkeherstellung, Brauereien, Süßwarenindustrie, Tabak",
    membershipMandatory: true,
  ...
  },
  {
    ...
    sectorDescription:
      "Zuständig für Unternehmen des Straßen-, Schienen- und Luftverkehrs sowie der Binnenschifffahrt, Post, Telekommunikation und Zeitarbeit (teils). Taxiunternehmen und Speditionen sind Pflichtmitglieder.",
    sectors:
      "Taxiunternehmen, Mietwagenunternehmen, Omnibusunternehmen, Speditionen, Post- und Kurierdienste, Binnenschifffahrt, Luftfahrtunternehmen, Kraftfahrzeughandel, Kraftfahrzeugreparatur (teils), Parkhäuser, Fahrradkuriere",
    membershipMandatory: true,
  ...
  },
  {
    ...
    shortName: "VBG",
    sectorDescription:
      "Zuständig für Unternehmen aus Verwaltung, Banken, Versicherungen, IT, Medien, freien Berufen und Bildung. Häufig die zuständige BG für Startups, Agenturen, IT-Firmen und Finanzdienstleister.",
    sectors:
      "Banken, Versicherungen, IT-Unternehmen, Unternehmensberatungen, Agenturen (Werbung, PR, Medien), freie Berufe (Steuerberater, Rechtsanwälte, Architekten), private Schulen, Verlage, Rundfunk, Fitnessstudios, Sicherheitsunternehmen (teils)",
    membershipMandatory: true,
  ...
  },
  {
    ...
    shortName: "BGW",
    sectorDescription:
      "Zuständig für nichtstaatliche Einrichtungen des Gesundheitswesens, der Sozialen Arbeit und der Wohlfahrtspflege. Ärzte in Praxen, Physiotherapeuten, Pflegedienste und Krankenhäuser in freier Trägerschaft sind Pflichtmitglieder.",
    sectors:
      "Arztpraxen (niedergelassene Ärzte), Zahnarztpraxen, Physiotherapiepraxen, Apotheken, ambulante Pflegedienste, Krankenhäuser (freie Träger), Alten- und Pflegeheime (freie Träger), Behinderteneinrichtungen, Kindergärten (freie Träger), Hebammen",
    membershipMandatory: true,
  ...
  },
  {
    ...
    shortName: "BGHW",
    sectorDescription:
      "Zuständig für Unternehmen des Einzelhandels, Großhandels und der Warenlogistik. Auch Online-Händler und Versandhändler sind Pflichtmitglieder, sofern die Lagerhaltung und Versandabwicklung im eigenen Betrieb erfolgt.",
    sectors:
      "Einzelhandel, Großhandel, Versandhandel (E-Commerce mit Lager), Warenlogistik, Lagerhaltung, Apotheken (teils, sofern keine BGW), Tankstellen, Kioske, Schreibwarenhandel",
    membershipMandatory: true,
  ...
  },
  {
    ...
    shortName: "BG ETEM",
    sectorDescription:
      "Zuständig für Betriebe der Energie- und Wasserwirtschaft, der Elektrotechnik, der Textil- und Bekleidungsbranche sowie der Medienproduktion (Druckerzeugnisse, Verlage — Produktion). Für Elektroinstallationsbetriebe zuständig, für Elektrohandwerksbetriebe teils BGHM.",
    sectors:
      "Energieversorgungsunternehmen, Elektroanlagenbau, Elektrohandwerk (teils), Textilherstellung, Bekleidungsherstellung, Lederverarbeitung, Schuhe, Druckereien, Verlagswesen (Produktion), Papierverarbeitung",
    membershipMandatory: true,
  ...
  },
  {
    ...
    sectors:
      "Landwirtschaft, Forstwirtschaft, Gartenbau (Zierpflanzen, Obst, Gemüse, Baumschulen), Weinbau, Imkerei, Fischerei (Binnengewässer), landwirtschaftliche Lohnunternehmen",
    membershipMandatory: true,
...
const PERMIT_SOURCE_URLS: Record<string, string> = Object.fromEntries(
...
class PermitsScraper extends BaseScraper<ParsedPermit> {
  constructor() {
    super({
      pipelineName: "scrape-genehmigungen-permits",
      pipelineDescription:
        "Scrapes German permit requirements (GewO, HwO, PBefG) from gesetze-im-internet.de and ihk.de (Silo 5: Genehmigungen & branchenspezifische Auflagen)",
  ...
  protected parsePage(html: string, url: string): ParsedPermit | null {
    ...
    const record: Omit<ParsedPermit, "contentHash"> = {
  ...
  protected async diffRecord(record: ParsedPermit): Promise<DiffResult> {
  ...
  protected async writeRecord(record: ParsedPermit): Promise<void> {
    const now = new Date();
    await db
      .insert(permits)
      .values({
...
const BG_SOURCE_URLS: Record<string, string> = Object.fromEntries(
  BASELINE_BGS.map((bg) => [
    bg.bgKey,
...
class BerufsgenossenschaftenScraper extends BaseScraper<ParsedBG> {
  constructor() {
    super({
      pipelineName: "scrape-genehmigungen-bg",
      pipelineDescription:
        "Scrapes Berufsgenossenschaft sector assignments from dguv.de (Silo 5: Genehmigungen & branchenspezifische Auflagen)",
      pipelineSchedule: "0 6 * * 1", // every Monday at 06:00 UTC
      requestDelayMs: 2000,
    });
  }
  ...
  protected parsePage(html: string, url: string): ParsedBG | null {
    ...
    const record: Omit<ParsedBG, "contentHash"> = {
  ...
  protected async diffRecord(record: ParsedBG): Promise<DiffResult> {
    const existing = await db
      .select({
  ...
  protected async writeRecord(record: ParsedBG): Promise<void> {
    const now = new Date();
    await db
...
export async function scrapeGenehmigungen(): Promise<void> {
