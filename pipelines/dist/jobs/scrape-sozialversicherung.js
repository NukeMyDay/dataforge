...
const DRV_BEITRAEGE_URL = "https://www.deutsche-rentenversicherung.de/DRV/DE/Experten/Zahlen-und-Fakten/Werte-der-Rentenversicherung/werte-der-rentenversicherung_node.html";
...
const GKV_BEITRAEGE_URL = "https://www.gkv-spitzenverband.de/krankenversicherung/beitraege/beitragssaetze/beitragssaetze.jsp";
...
const BA_BEITRAEGE_URL = "https://www.arbeitsagentur.de/datei/beitraege-zur-sozialversicherung_ba014364.pdf";
...
const MINIJOB_URL = "https://www.minijob-zentrale.de/DE/01_minijobs/02_gewerblich/02_was_zahlt_der_arbeitgeber/node.html";
// bundesgesundheitsministerium.de — primary authority for Pflegeversicherung rates (§ 55 SGB XI).
const BMG_PFLEGE_URL = "https://www.bundesgesundheitsministerium.de/themen/pflege/pflegeversicherung-zahlen-und-fakten.html";
...
const BMAS_URL = "https://www.bmas.de/DE/Arbeit/Arbeitsrecht/arbeitsrecht.html";
// ─── Helpers ─────────────────────────────────────────────────────────────────
...
function extractRate(text, keyword) {
    ...
    const re = new RegExp(`${escaped}[^\\d]{0,80}?(\\d{1,2}[,.]\\d{1,2})\\s*(?:Prozent|%)`, "i");
...
const BASELINE_RATES = [
    {
        ...
        rateEmployer: "7.3%",
        rateEmployee: "7.3%",
        notesDe: "Allgemeiner Beitragssatz nach § 241 SGB V. Hinzu kommt ein einkommensabhängiger Zusatzbeitrag (2025 avg. ca. 1.7%), der hälftig geteilt wird. Gesamtbelastung ca. 16.3%.",
    ...
    },
    {
        ...
        rateEmployer: "9.3%",
        rateEmployee: "9.3%",
        notesDe: "Beitragssatz nach § 158 SGB VI. Gilt bis zur Beitragsbemessungsgrenze (West 2025: 8.050 €/Monat, Ost: 7.450 €/Monat).",
        validFrom: "2025-01-01",
    ...
    },
    {
        ...
        rateEmployer: "1.3%",
        rateEmployee: "1.3%",
        notesDe: "Beitragssatz nach § 341 SGB III. Gilt bis zur Beitragsbemessungsgrenze der Rentenversicherung.",
        validFrom: "2025-01-01",
    ...
    },
    {
        ...
        rateEmployer: "1.7%",
        rateEmployee: "1.7%",
        notesDe: "Beitragssatz nach § 55 SGB XI. Kinderlose Arbeitnehmer zahlen einen Zuschlag von 0.6%. In Sachsen trägt der Arbeitgeber nur 1.2%, der Arbeitnehmer 2.2%.",
        validFrom: "2025-01-01",
    ...
    },
    {
        ...
        rateEmployer: "13%",
        rateEmployee: "0%",
        notesDe: "Pauschalabgabe für geringfügig Beschäftigte bis 538 €/Monat (§ 249b SGB V). Nur vom Arbeitgeber getragen.",
        validFrom: "2025-01-01",
    ...
    },
    {
        ...
        rateEmployer: "15%",
        rateEmployee: "0%",
        notesDe: "Pauschalabgabe für gewerbliche Minijobs bis 538 €/Monat (§ 172 SGB VI). Arbeitnehmer können auf Rentenversicherungspflicht verzichten (Befreiung möglich), zahlen sonst Aufstockungsbeitrag auf 18.6%.",
        validFrom: "2025-01-01",
        sourceUrl: MINIJOB_URL,
    },
];
const BASELINE_OBLIGATIONS = [
    {
        ...
        descriptionDe: "Arbeitgeber müssen neu eingestellte Arbeitnehmer bei der zuständigen Krankenkasse zur Sozialversicherung anmelden. Die Anmeldung muss spätestens mit der ersten Lohn-/Gehaltsabrechnung, in jedem Fall aber innerhalb von 6 Wochen nach Beschäftigungsbeginn erfolgen.",
    ...
    },
    {
        ...
        descriptionDe: "Arbeitnehmer haben das Recht, ihre gesetzliche Krankenkasse frei zu wählen (§ 173 SGB V). Der Arbeitgeber meldet den Arbeitnehmer bei der vom Arbeitnehmer gewählten Krankenkasse an. Wählt der Arbeitnehmer keine Krankenkasse, kann der Arbeitgeber eine zuweisen. Die Krankenkasse ist gleichzeitig Einzugsstelle für alle Sozialversicherungsbeiträge.",
        descriptionEn: "Employees are free to choose their statutory health insurer (§ 173 SGB V). The employer registers the employee with the chosen Krankenkasse, which also collects all social insurance contributions.",
        deadlineInfo: null,
    ...
    },
    {
        ...
        descriptionDe: "Minijobs sind Beschäftigungen bis 538 €/Monat (seit Oktober 2022). Arbeitgeber zahlen Pauschalabgaben von 13% KV + 15% RV + 2% Pauschalsteuer (insgesamt ca. 31%). Arbeitnehmer sind von Krankenversicherungsbeiträgen befreit, bleiben aber rentenversicherungspflichtig (können sich befreien lassen). Für Beschäftigungen zwischen 538,01 € und 2.000 € gilt die Gleitzonenregelung (Übergangsbereich).",
    ...
    },
    {
        ...
        descriptionDe: "Das Kündigungsschutzgesetz (KSchG) gilt für Betriebe mit mehr als 10 Arbeitnehmern und nach 6-monatiger Betriebszugehörigkeit. Kündigungen müssen sozial gerechtfertigt sein (personen-, verhaltens- oder betriebsbedingt). Für besondere Personengruppen (Schwangere, Schwerbehinderte, Betriebsräte) gelten Sonderkündigungsschutzregeln.",
    ...
    },
    {
        ...
        descriptionDe: "Bestimmte Berufsgruppen von Selbstständigen unterliegen der gesetzlichen Rentenversicherungspflicht (§ 2 SGB VI), z. B. Handwerker, Lehrer, Erzieher, Pflegepersonen, Künstler und Publizisten (KSK), sowie Selbstständige mit nur einem Auftraggeber. Der Beitragssatz beträgt 18,6% des beitragspflichtigen Einkommens.",
        descriptionEn: "Certain categories of self-employed persons are compulsorily insured in the statutory pension scheme (§ 2 SGB VI), including craftspeople, teachers, nurses, artists and journalists (KSK), and the self-employed with a single client. The contribution rate is 18.6% of pensionable income.",
...
class SvBeitraegeScraper extends BaseScraper {
    constructor() {
        super({
    ...
    async fetchUrls(_page) {
        ...
        return Object.entries(RATE_SOURCE_URLS).map(([type, url]) => `${url}#sv-type=${encodeURIComponent(type)}`);
    }
    parsePage(html, url) {
        ...
        if (!insuranceType)
            return null;
        const baseline = BASELINE_RATES.find((r) => r.insuranceType === insuranceType);
        if (!baseline)
            return null;
        ...
        const noteSection = extractSection($, ["hinweis", "zusatzbeitrag", "besonderheit"]) ??
            baseline.notesDe;
        const record = {
            insuranceType,
...
class SvPflichtenScraper extends BaseScraper {
    constructor() {
        super({
    ...
    parsePage(html, url) {
        ...
        if (!obligationType)
            return null;
        const baseline = BASELINE_OBLIGATIONS.find((o) => o.obligationType === obligationType);
        if (!baseline)
            return null;
        const $ = cheerio.load(html);
        ...
        const descriptionDe = liveSection && liveSection.length > 100
            ? liveSection
...
export async function scrapeSozialversicherung() {
    const beitraegeScraper = new SvBeitraegeScraper();
    const beitraegeStats = await beitraegeScraper.run();
    console.log(`[scrape-sv-beitraege] Done — new: ${beitraegeStats.newCount}, ` +
    ...
    console.log(`[scrape-sv-pflichten] Done — new: ${pflichtenStats.newCount}, ` +
        `updated: ${pflichtenStats.updatedCount}, ` +
        `unchanged: ${pflichtenStats.unchangedCount}, ` +
        `errors: ${pflichtenStats.errorCount}`);
}
//# sourceMappingURL=scrape-sozialversicherung.js.map