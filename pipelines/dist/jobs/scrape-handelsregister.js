...
const BNK_COSTS_URL = "https://www.bundesnotarkammer.de/notare/notarkosten";
...
const BMJ_GMBHG_URL = "https://www.bmj.bund.de/DE/Themen/RechtundGesetze/Gesellschaftsrecht/Gesellschaftsrecht_node.html";
// ─── Helpers ──────────────────────────────────────────────────────────────────
function makeHash(data) {
    return createHash("sha256").update(JSON.stringify(data)).digest("hex");
}
const BASELINE_OBLIGATIONS = [
    // ── Eintragungspflicht ────────────────────────────────────────────────────
    {
        rechtsformSlug: "gmbh",
        obligationType: "eintragungspflicht",
        labelDe: "Eintragungspflicht GmbH",
        descriptionDe: "Die GmbH entsteht als juristische Person erst mit Eintragung in das Handelsregister (§ 11 Abs. 1 GmbHG). Vor der Eintragung haftet die Vorgesellschaft (Vor-GmbH) als solche; die Gründer haften persönlich für Verbindlichkeiten der Vor-GmbH. Die Anmeldung muss notariell beglaubigt beim zuständigen Amtsgericht (Registergericht) eingereicht werden. Das Stammkapital muss bei Anmeldung mindestens zur Hälfte (12.500 €) eingezahlt sein.",
        descriptionEn: "The GmbH only becomes a legal entity upon entry in the commercial register (§ 11 para. 1 GmbHG). Before registration, the pre-company (Vor-GmbH) exists; founders are personally liable for its obligations. The application must be notarially authenticated and submitted to the competent local court (Registergericht). At least half the share capital (€12,500) must be paid up at the time of application.",
        isMandatory: true,
    ...
    },
    {
        ...
        descriptionDe: "Die OHG (Offene Handelsgesellschaft) entsteht im Innenverhältnis mit Abschluss des Gesellschaftsvertrags, im Außenverhältnis (als Kaufmann gegenüber Dritten) aber erst mit Eintragung in das Handelsregister (§ 123 Abs. 1 HGB). Betreibt die OHG ein Handelsgewerbe, ist die Eintragung Pflicht (§ 106 HGB). Die Haftung der Gesellschafter ist persönlich und unbeschränkt (§ 128 HGB).",
        descriptionEn: "The OHG (general partnership) is formed internally upon signing the partnership agreement, but only becomes effective externally (as a merchant vis-à-vis third parties) upon registration in the commercial register (§ 123 para. 1 HGB). If the OHG operates a commercial enterprise, registration is mandatory (§ 106 HGB). Partners are personally and unlimitedly liable (§ 128 HGB).",
        isMandatory: true,
    ...
    },
    {
        ...
        descriptionDe: "Die Gründung einer AG erfordert die notarielle Beurkundung der Satzung und der Gründungserklärungen (§§ 23, 28 AktG). Weitere notarpflichtige Akte: Satzungsänderungen (§ 130 AktG), Kapitalerhöhungen (§ 182 AktG), Verschmelzungsverträge. Der Notar übernimmt auch die Anmeldung zum Handelsregister.",
        descriptionEn: "Founding an AG requires notarial authentication of the articles of association and the founding declarations (§§ 23, 28 AktG). Other acts requiring notarization: amendments to the articles of association (§ 130 AktG), capital increases (§ 182 AktG), and merger agreements. The notary also handles the commercial register application.",
        isMandatory: true,
    ...
    },
    {
        ...
        descriptionDe: "Der Gesellschaftsvertrag einer OHG bedarf keiner notariellen Form (formfrei nach § 705 BGB i.V.m. §§ 105 ff. HGB). Jedoch muss die Anmeldung zum Handelsregister notariell beglaubigt eingereicht werden (§ 12 HGB). Beinhaltet der Gesellschaftsvertrag eine Grundstückseinlage, ist für diesen Teil notarielle Beurkundung erforderlich (§ 311b BGB).",
        descriptionEn: "The partnership agreement of an OHG requires no notarial form (informal under § 705 BGB in conjunction with §§ 105 ff. HGB). However, the application to the commercial register must be notarially certified (§ 12 HGB). If the partnership agreement includes a real estate contribution, that part requires notarial authentication (§ 311b BGB).",
        isMandatory: false,
    ...
    },
    {
        ...
        descriptionDe: "Für die Gründung eines Einzelunternehmens ist keine notarielle Beurkundung erforderlich. Die Anmeldung zum Handelsregister (sofern Eintragungspflicht besteht) muss jedoch in notariell beglaubigter Form eingereicht werden (§ 12 HGB). Immobilienerwerb im Rahmen der Betriebsgründung erfordert notarielle Beurkundung (§ 311b BGB).",
        descriptionEn: "No notarial authentication is required to found a sole tradership. However, if registration in the commercial register is required, the application must be submitted in notarially certified form (§ 12 HGB). Acquisition of real estate as part of the business setup requires notarial authentication (§ 311b BGB).",
        isMandatory: false,
    ...
    },
    {
        ...
        descriptionDe: "Der Vorstand und die Mitglieder des Aufsichtsrats haben die AG zur Eintragung in das Handelsregister unverzüglich nach der Gründungsversammlung anzumelden (§ 36 Abs. 1 AktG). Auch hier gilt: keine gesetzliche Maximalfrist, aber unverzügliches Handeln ist geboten. Die AG entsteht erst mit der Eintragung.",
        descriptionEn: "The board of directors and supervisory board members must apply for registration in the commercial register immediately after the founding meeting (§ 36 para. 1 AktG). Again, there is no statutory maximum deadline, but prompt action is required. The AG only comes into existence upon registration.",
        isMandatory: true,
    ...
    },
    {
        ...
        descriptionDe: "Die UG unterliegt denselben Offenlegungspflichten wie die GmbH (§ 325 HGB). Da UGs in der Regel kleine Kapitalgesellschaften sind, genügt die vereinfachte Offenlegung (nur Bilanz und Anhang). Frist: 12 Monate nach Ablauf des Geschäftsjahres.",
        descriptionEn: "The UG is subject to the same disclosure obligations as the GmbH (§ 325 HGB). As UGs are typically small companies, the simplified disclosure (balance sheet and notes only) is sufficient. Deadline: 12 months after the end of the financial year.",
        isMandatory: true,
    ...
    },
    {
        ...
        descriptionEn: "Sole traders who do not exceed €600,000 in revenue and €60,000 net profit at two consecutive closing dates (§ 241a HGB) are exempt from accounting obligations under the HGB and therefore also from the disclosure requirement. Larger sole traders are subject to the general disclosure obligations of the HGB.",
        isMandatory: false,
    ...
    // ── Ablauf GmbH-Gründung ──────────────────────────────────────────────────
    {
        ...
        descriptionDe: "1. Gesellschaftsvertrag (Satzung) aufsetzen — Firma, Sitz, Stammkapital (mind. 25.000 €), Unternehmensgegenstand, Geschäftsführer, Gesellschafter und Beteiligungsquoten festlegen.\n" +
        ...
        descriptionEn: "1. Draft articles of association — define company name (Firma), registered office (Sitz), share capital (min. €25,000), business purpose, managing directors, shareholders, and shareholding ratios.\n" +
    ...
    // ── Ablauf UG-Gründung ────────────────────────────────────────────────────
    {
        ...
        descriptionDe: "1. Gesellschaftsvertrag oder Musterprotokoll wählen — Bei bis zu 3 Gesellschaftern und einem Geschäftsführer kann das gesetzliche Musterprotokoll (Anlage zu § 2 Abs. 1a GmbHG) genutzt werden; spart Notarkosten.\n" +
        ...
        descriptionEn: "1. Choose articles or standard form — For up to 3 shareholders and one managing director, the statutory standard form (Musterprotokoll, Annex to § 2 para. 1a GmbHG) can be used; saves notary costs.\n" +
...
const BASELINE_NOTARY_COSTS = [
    {
        actType: "gmbh_gruendung",
        labelDe: "GmbH-Gründung (Beurkundung Gesellschaftsvertrag)",
        costBasis: "GNotKG Anlage 1 Nr. 21100 (Beurkundungsgebühr), Geschäftswert = Stammkapital (mindestens 25.000 €). " +
        ...
        notes: "Bei Stammkapital von 25.000 € beträgt die Notargebühr ca. 300–400 €. Zzgl. Mehrwertsteuer (19%). " +
    ...
    },
    {
        ...
        costBasis: "GNotKG Anlage 1 Nr. 21100 reduziert, Geschäftswert = Stammkapital. " +
        ...
        notes: "Nur bei bis zu 3 Gesellschaftern, 1 Geschäftsführer, Sacheinlagen ausgeschlossen. " +
    ...
    },
    {
        ...
        costBasis: "GNotKG Anlage 1 Nr. 21100 (Beurkundungsgebühr), Geschäftswert = Grundkapital (mind. 50.000 €). " +
            "Zzgl. Gerichtsgebühr für Handelsregistereintragung.",
        exampleCostEur: "600–1.500 € (Notargebühr) + 300–600 € (Gerichtsgebühr)",
        notes: "Bei Grundkapital von 50.000 € ca. 600–800 € Notargebühr zzgl. MwSt. " +
    ...
    },
    {
        ...
        costBasis: "GNotKG Anlage 1 Nr. 21100 (Beurkundungsgebühr), Geschäftswert = Wert der Änderung bzw. " +
        ...
        notes: "Jede Änderung des Gesellschaftsvertrags (§ 53 GmbHG) bedarf notarieller Beurkundung und " +
    ...
    },
    {
        ...
        costBasis: "GNotKG Anlage 1 Nr. 21100 (Beurkundungsgebühr), Geschäftswert = Kaufpreis der Anteile oder " +
            "Nennbetrag, je nachdem was höher ist (§ 97 GNotKG).",
        exampleCostEur: "300–2.000 € (je nach Anteilswert)",
        notes: "Anteilsübertragungen bei der GmbH sind nach § 15 GmbHG zwingend notariell zu beurkunden. " +
    ...
    },
    {
        ...
        costBasis: "Notarielle Beglaubigung der Unterschrift (§ 12 HGB). Gebühr nach GNotKG: Beglaubigungsgebühr " +
        ...
        notes: "Günstigste Form der HR-Anmeldung: nur Unterschriftsbeglaubigung erforderlich, keine " +
...
export class HandelsregisterScraper extends BaseScraper {
    constructor() {
        super({
            ...
            pipelineDescription: "Scrapes Handelsregister obligations and notary requirements for German founders (Silo 6)",
    ...
    async fetchUrls(_page) {
        const obligationUrls = BASELINE_OBLIGATIONS.map((o) => `${o.sourceUrl}#hr-${o.rechtsformSlug}-${o.obligationType}`);
        const notaryUrls = BASELINE_NOTARY_COSTS.map((n) => `${n.sourceUrl}#notar-${n.actType}`);
    ...
    parseObligationPage(html, url, fragment) {
        ...
        const baseline = BASELINE_OBLIGATIONS.find((o) => o.rechtsformSlug === rechtsformSlug &&
    ...
    parseNotaryCostPage(html, url, fragment) {
        ...
        const $ = cheerio.load(html);
        let extractedCostText = null;
        $("p, li, td").each((_, el) => {
            const text = $(el).text().trim().toLowerCase();
            if ((text.includes("gnotkg") || text.includes("gebühr")) &&
                text.length > 50) {
    ...
    async diffObligation(record) {
        const existing = await db
            .select({ id: hrObligations.id, contentHash: hrObligations.contentHash })
            .from(hrObligations)
            .where(and(eq(hrObligations.rechtsformSlug, record.rechtsformSlug), eq(hrObligations.obligationType, record.obligationType)))
            .limit(1);
...
//# sourceMappingURL=scrape-handelsregister.js.map