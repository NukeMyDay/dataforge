...
const BMF_STEUERN_URL = "https://www.bundesfinanzministerium.de/Web/DE/Themen/Steuern/steuern.html";
...
const ELSTER_URL = "https://www.elster.de/eportal/helpGlobal?themaGlobal=hilfe_registrierung";
// bundesrat.de — Secondary authority for GewStG and Landessteuerrecht context.
const BUNDESRAT_GEWERBESTEUER_URL = "https://www.bundesrat.de/DE/themen/steuern/steuern-node.html";
// ─── Helpers ──────────────────────────────────────────────────────────────────
...
const BASELINE_OBLIGATIONS = [
    // ── Körperschaftsteuer (GmbH, UG) ─────────────────────────────────────────
    {
        ...
        descriptionDe: "Kapitalgesellschaften (GmbH, UG) unterliegen der Körperschaftsteuer (KSt) auf ihren zu versteuernden Gewinn. Der Steuersatz beträgt einheitlich 15% (§ 23 Abs. 1 KStG) zzgl. 5,5% Solidaritätszuschlag auf die KSt-Schuld (effektiv 15,825%). Die Steuer wird quartalsweise als Vorauszahlung (10. März, 10. Juni, 10. September, 10. Dezember) und jährlich mit der Körperschaftsteuererklärung abgerechnet. Steuersubjekt ist die Kapitalgesellschaft, nicht die Gesellschafter.",
        descriptionEn: "Limited liability companies (GmbH, UG) are subject to corporate income tax (Körperschaftsteuer) on their taxable profit at a flat rate of 15% (§ 23 para. 1 KStG) plus 5.5% solidarity surcharge on the tax amount (effective rate 15.825%). Tax is paid quarterly as advance payments and settled annually via the corporate tax return. The taxable entity is the company, not its shareholders.",
    ...
    },
    {
        ...
        taxType: "gewerbesteuer",
        labelDe: "Gewerbesteuer",
        descriptionDe: "Die UG (haftungsbeschränkt) unterliegt wie die GmbH der Gewerbesteuer ohne Freibetrag (§ 2 Abs. 2 GewStG). Steuermesszahl 3,5% × Hebesatz der Gemeinde. Da UGs oft in der Anfangsphase geringe Gewinne haben, kann die Gewerbesteuerlast anfänglich niedrig sein, besteht aber ab dem ersten Gewinn.",
        descriptionEn: "The UG (haftungsbeschränkt) is subject to trade tax without a tax-free allowance (§ 2 para. 2 GewStG), like the GmbH. Tax index 3.5% × municipal Hebesatz. Since UGs often have small profits in early stages, the initial trade tax burden may be low but applies from the first profit.",
        rateInfo: "Steuermesszahl 3,5% × Hebesatz der Gemeinde (mind. 200%)",
        filingFrequency: "jährlich (Vorauszahlungen quartalsweise)",
        registrationRequired: true,
        kleinunternehmerRelevant: false,
    ...
    },
    {
        ...
        descriptionEn: "Sole traders operating a commercial business (not freelancers) are subject to trade tax. The tax-free allowance for natural persons is €24,500 (§ 11 para. 1 sentence 3 No. 1 GewStG). Trade tax reduces the income tax burden because it is credited (at 4× the trade tax index) against income tax (§ 35 EStG). In practice, trade tax for small sole traders is often fully offset by § 35 EStG.",
    ...
    },
    {
        ...
        descriptionEn: "A commercial GbR is subject to trade tax as an entity (§ 5 para. 1 GewStG). Tax-free allowance: €24,500. Trade tax is credited against each partner's income tax via § 35 EStG. A freelance GbR (all partners are freelancers per § 18 EStG) is not subject to trade tax — mixed partnerships (partly commercial, partly freelance) must check the contamination rule (Abfärberegelung, § 15 para. 3 EStG).",
    ...
    // ── Kleinunternehmerregelung ───────────────────────────────────────────────
    {
        ...
        descriptionDe: "Unternehmer mit einem Vorjahresumsatz bis 25.000 € (netto) und einem voraussichtlichen Umsatz im laufenden Jahr bis 100.000 € (ab 2025; vorher 50.000 €) können die Kleinunternehmerregelung in Anspruch nehmen. Folge: keine Umsatzsteuerausweis auf Rechnungen, keine Abführung von USt, kein Vorsteuerabzug. Vorteile: geringerer Verwaltungsaufwand, günstigere Preise für Privatpersonen. Nachteile: kein Vorsteuerabzug (ungünstig bei hohen Vorleistungen), Brutto-Einnahmen sind Umsatzgrenze. Die Regelung gilt für alle Rechtsformen, ausgenommen Kapitalgesellschaften (GmbH/UG) sind theoretisch eingeschlossen, aber praktisch selten relevant. Wahlmöglichkeit zur Regelbesteuerung (Option nach § 19 Abs. 2 UStG, 5-Jahres-Bindung).",
...
const BASELINE_DEADLINES = [
    {
        ...
        deadlineDescription: "Unternehmer mit einer Vorjahres-USt-Schuld von über 7.500 € müssen monatlich eine Umsatzsteuer-Voranmeldung über ELSTER einreichen und die USt entrichten. Fälligkeit: 10. des Folgemonats. Dauerfristverlängerung um 1 Monat möglich (gegen 1/11 der Vorjahressteuer als Sondervorauszahlung, § 47 UStDV).",
    ...
    },
    {
        ...
        deadlineDescription: "Unternehmer mit einer Vorjahres-USt-Schuld zwischen 1.000 € und 7.500 € reichen die Voranmeldung quartalsweise ein. Fälligkeitstermine: 10. April, 10. Juli, 10. Oktober, 10. Januar. Dauerfristverlängerung möglich. Neugründer (Jahr 1 und 2) sind stets zur monatlichen Voranmeldung verpflichtet.",
    ...
    },
    {
        ...
        deadlineDescription: "Die USt-Jahreserklärung ist grundsätzlich bis zum 31. Juli des Folgejahres einzureichen (§ 149 Abs. 2 AO). Mit Steuerberater: Verlängerung bis 28./29. Februar des übernächsten Jahres möglich. Kleinunternehmer sind von der Voranmeldungspflicht befreit, müssen aber ggf. eine Jahreserklärung abgeben.",
    ...
    },
    {
        ...
        deadlineDescription: "Selbstständige und Gewerbetreibende müssen eine jährliche Einkommensteuererklärung beim Finanzamt einreichen. Grundfrist: 31. Juli des Folgejahres. Mit Steuerberater/Lohnsteuerhilfeverein: 28./29. Februar des übernächsten Jahres. Bei verspäteter Abgabe können Verspätungszuschläge (0,25% der festgesetzten Steuer, mind. 25 € je angefangenem Monat, max. 25.000 €) anfallen.",
    ...
    },
    {
        ...
        deadlineDescription: "Selbstständige und Gewerbetreibende zahlen quartalsweise Einkommensteuer-Vorauszahlungen, die das Finanzamt auf Basis der Vorjahressteuer oder einer voraussichtlichen Steuerschuld festsetzt. Fälligkeitstermine: 10. März, 10. Juni, 10. September, 10. Dezember. Anpassung der Vorauszahlungen kann beantragt werden.",
    ...
    },
    {
        ...
        deadlineDescription: "GmbH und UG leisten quartalsweise Körperschaftsteuer-Vorauszahlungen (15% + SolZ). Fälligkeitstermine identisch mit Einkommensteuer-Vorauszahlungen: 10. März, 10. Juni, 10. September, 10. Dezember. Basis: festgesetzter Vorauszahlungsbetrag, der sich an der Vorjahressteuer orientiert.",
    ...
    },
    {
        ...
        deadlineDescription: "Kapitalgesellschaften (GmbH, UG) müssen jährlich eine Körperschaftsteuererklärung (KSt 1) sowie eine Gewerbesteuererklärung einreichen. Grundfrist: 31. Juli des Folgejahres. Mit Steuerberater: 28./29. Februar des übernächsten Jahres.",
        dueDateInfo: "31. Juli des Folgejahres (mit Steuerberater: 28./29. Februar)",
    ...
    },
    {
        ...
        deadlineDescription: "Gewerbesteuerpflichtige Unternehmen zahlen quartalsweise Vorauszahlungen. Fälligkeitstermine: 15. Februar, 15. Mai, 15. August, 15. November (§ 21 GewStG). Basis: Vorauszahlungsbescheid der Gemeinde. Die Abweichung von den ESt/KSt-Vorauszahlungsterminen ist zu beachten.",
    ...
    },
    {
        ...
        deadlineDescription: "Gewerbesteuerpflichtige Unternehmen reichen jährlich eine Gewerbesteuererklärung beim zuständigen Finanzamt ein. Die Gemeinde setzt dann den Gewerbesteuerbescheid fest. Grundfrist: 31. Juli des Folgejahres. Mit Steuerberater: 28./29. Februar des übernächsten Jahres.",
        dueDateInfo: "31. Juli des Folgejahres (mit Steuerberater: 28./29. Februar)",
...
const OBLIGATION_SOURCE_URLS = Object.fromEntries(BASELINE_OBLIGATIONS.map((o) => [
    `${o.rechtsformSlug}|${o.taxType}`,
    `${o.sourceUrl}#tax-obl=${encodeURIComponent(`${o.rechtsformSlug}|${o.taxType}`)}`,
]));
class TaxObligationsScraper extends BaseScraper {
    constructor() {
        super({
            pipelineName: "scrape-steuern-pflichten",
            pipelineDescription: "Scrapes German tax obligations per Rechtsform from bundesfinanzministerium.de and elster.de (Silo 3: Steuerliche Pflichten für Gründer)",
    ...
    parsePage(html, url) {
        ...
        if (!rechtsformSlug || !taxType)
            return null;
        const baseline = BASELINE_OBLIGATIONS.find((o) => o.rechtsformSlug === rechtsformSlug && o.taxType === taxType);
        if (!baseline)
            return null;
    ...
    async diffRecord(record) {
        const existing = await db
            ...
            .from(taxObligations)
            .where(and(eq(taxObligations.rechtsformSlug, record.rechtsformSlug), eq(taxObligations.taxType, record.taxType)))
            .limit(1);
...
const DEADLINE_SOURCE_URLS = Object.fromEntries(BASELINE_DEADLINES.map((d) => [
    `${d.taxType}|${d.eventTrigger}`,
    `${d.sourceUrl}#tax-dl=${encodeURIComponent(`${d.taxType}|${d.eventTrigger}`)}`,
]));
class TaxDeadlinesScraper extends BaseScraper {
    constructor() {
        super({
            pipelineName: "scrape-steuern-fristen",
            pipelineDescription: "Scrapes German tax filing deadlines from bundesfinanzministerium.de and elster.de (Silo 3: Steuerliche Pflichten für Gründer)",
            pipelineSchedule: "0 5 * * 1", // every Monday at 05:00 UTC
            requestDelayMs: 2000,
        });
    }
    ...
    parsePage(html, url) {
        ...
        if (!taxType || !eventTrigger)
            return null;
        const baseline = BASELINE_DEADLINES.find((d) => d.taxType === taxType && d.eventTrigger === eventTrigger);
        if (!baseline)
            return null;
        const $ = cheerio.load(html);
        ...
        const deadlineDescription = liveSection && liveSection.length > 80
            ? liveSection
    ...
    async diffRecord(record) {
        const existing = await db
            ...
            .from(taxDeadlines)
            .where(and(eq(taxDeadlines.taxType, record.taxType), eq(taxDeadlines.eventTrigger, record.eventTrigger)))
            .limit(1);
        if (existing.length === 0)
            return "new";
        if (existing[0].contentHash === record.contentHash)
...
export async function scrapeSteuern() {
    const pflichtenScraper = new TaxObligationsScraper();
    const pflichtenStats = await pflichtenScraper.run();
    console.log(`[scrape-steuern-pflichten] Done — new: ${pflichtenStats.newCount}, ` +
    ...
    console.log(`[scrape-steuern-fristen] Done — new: ${fristenStats.newCount}, ` +
        `updated: ${fristenStats.updatedCount}, ` +
        `unchanged: ${fristenStats.unchangedCount}, ` +
        `errors: ${fristenStats.errorCount}`);
}
//# sourceMappingURL=scrape-steuern.js.map